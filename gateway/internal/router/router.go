...
func New() *gin.Engine {
	...
	userGroup.GET("/memory/settings", handler.GetUserMemorySetting)
	userGroup.PUT("/memory/settings", handler.UpdateUserMemorySetting)
	...
	conversationGroup.GET("/:conversationId/join-requests", handler.ListGroupJoinRequests)
	conversationGroup.POST("/:conversationId/join-requests/:requestId/review", handler.ReviewGroupJoinRequest)
	...
	conversationGroup.PUT("/:conversationId/avatar", handler.UpdateGroupAvatar)
	conversationGroup.DELETE("/:conversationId/group", handler.DisbandGroup)
