...
type MembershipManager interface {
	AddBotToConversation(ctx context.Context, conversationID, botID uint64) error
	AddBotToConversationWithConfig(ctx context.Context, conversationID, botID uint64, cfg ConversationBotConfig) error
	RemoveBotFromConversation(ctx context.Context, conversationID, botID uint64) error
}
